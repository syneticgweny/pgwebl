...
@section('content')
    ...
    <!-- Modal Edit Polygons-->
    <div class="modal fade" id="EditPolygonsModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <script>
        ...
        map.on('draw:edited', function(e) {
            ...
            layers.eachLayer(function(layer) {
                ...
                //menampilkan data ke dalam modal edit polygons
                ...
                //menampilkan modal edit polygons
